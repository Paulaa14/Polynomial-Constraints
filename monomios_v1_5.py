...
A partir de la versión booleana con los huecos para rellenar las VI y monomios, se permite en esta implementación seleccionar VI de cualquier nivel
para rellenar los huecos, además de factores
